...
import 'package:hotel_management_app/New Folder/Login.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  final TextEditingController _luxuryController = TextEditingController();
  ...
  void navigateToDashboard(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            Dashboard(indexValue: 2), // Pass the initial index
      ),
    );
  }
  ...
  void _registerManager() async {
    try {
      ...
      await FirebaseFirestore.instance.collection('managers').add({
        ...
        'password': _passwordController.text,
        'Number of Single Rooms': _singleController.text,
        'Number of Double Rooms': _doubleController.text,
        'Number of Family Rooms': _familyController.text,
        'Number of Luxury Rooms': _luxuryController.text,
  ...
  Future<void> _registerUser() async {
    ...
    String single=_singleController.text;
    String double =_singleController.text;
    String family=_singleController.text;
    String luxury=_singleController.text;
    ...
    try {
      if (name.isNotEmpty && _passwordController.text.isNotEmpty) {
        ...
        await firestore.collection('managers').add({
          'name': name,
          'email': email,
          'phone': phone,
          'hotelName': hotelName,
          ...
          'Number of Family Rooms': family,
          'Number of Luxury Rooms': luxury,
        });
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  labelText: 'Number of Single Rooms',
                  labelStyle: GoogleFonts.getFont('Josefin Sans',
                      color: Colors.blueGrey),
                  prefixIcon: const Icon(
                    Icons.hotel,
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  labelText: 'Number of Double Rooms',
                  // hintText: 'example01@gmail.com',
                  hintStyle: GoogleFonts.getFont(
                    'Josefin Sans',
                  ),
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  labelText: 'Number of Family Rooms',
                  labelStyle: GoogleFonts.getFont('Josefin Sans',
                      color: Colors.blueGrey),
                  prefixIcon: const Icon(
                    Icons.hotel,
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  labelText: 'Number of Luxury Rooms',
                  labelStyle: GoogleFonts.getFont(
                    'Josefin Sans',
                    color: Colors.blueGrey,
                  ),
